...
@section('content')
    ...
    <h1 style="padding: 20px; color: #CDA566">CẬP NHẬT NHÀ CUNG CẤP</h1>
    ...
    <div style="padding: 20px" class="">
        ...
        <div class="page-header">
            <h2 class="header-title">Cập Nhật nhà cung cấp</h2>
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash">
                    <a href="#" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Trang chủ</a>
                    <a class="breadcrumb-item" href="#">Nhà cung cấp</a>
                    <a class="breadcrumb-item active" href="#">Cập nhật nhà cung cấp</a>
                </nav>
            </div>
        </div>
                ...
                <div id="data-table_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    ...
                    <form action="{{ route('updateSupplier') }}" method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="text"  name="name_supplier" placeholder="Ten..." value=" {{old('name_supplier') ?? $supplierDetail->TenNhaCC}} " type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">                       
                        </div>
                        @error('name_supplier')
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="text"  name="addr_supplier" placeholder="Ten..." value=" {{old('addr_supplier') ?? $supplierDetail->DiaChi}} " type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">                      
                        </div>
                        @error('addr_supplier')
                            <span style="color:red;display: block;margin-bottom: 10px; ">{{$message}}</span>
                        @enderror
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="text"  name="phone_supplier" placeholder="Ten..." value=" {{old('phone_supplier') ?? $supplierDetail->SĐTh}} " type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="text"  name="email_supplier" placeholder="Ten..." value=" {{old('email_supplier') ?? $supplierDetail->Email}} " type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                        </div>
