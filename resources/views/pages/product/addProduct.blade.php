...
@section('content')
    ...
    <h1 style="padding: 20px; color: #CDA566">THÊM MÓN</h1>
        ...
        <div class="page-header">
            ...
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash">
                    ...
                    <a class="breadcrumb-item active" href="#">Thêm món</a>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="text"  name="name_product"  value=" {{old('name_product')}} " type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                    </div>
                                    @error('name_product')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="text"  name="price_product"  value=" {{old('price_product')}} " type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                    </div>
                                    @error('price_product')
                                        <span style="color:red;display: block;margin-bottom: 10px; ">{{$message}}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="text"  name="unit_product"  value=" {{old('unit_product')}} " type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                    </div>
                                    @error('unit_product')
                                        <span style="color:red;display: block;margin-bottom: 10px; ">{{$message}}</span>
                                    @enderror
                            ...
                            <div class="card-body">
                                <div id="productDescription">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <textarea  name="des_product" value=" {{old('des_product')}} " class="form-control" aria-label="With textarea"></textarea>
                                    </div>
                                    @error('des_product')
                                        <span style="color:red;display: block;margin-bottom: 10px;">{{$message}}</span>
                                    @enderror
